...
compared with the other six days. In terms of point dispersion, there
was more activity per minute on Friday and Wednesday. It can be seen
from the figure that the amount of activity in the middle period is
generally low, which indicates that the man is likely sleeping during
this period.
